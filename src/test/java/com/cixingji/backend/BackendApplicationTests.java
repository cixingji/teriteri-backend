...
//    }
    ...
    void bulkAddDocSearchWord() throws IOException {
        ...
        for (Object word : words) {
            ESSearchWord esSearchWord = new ESSearchWord(word.toString());
            bulkOperationList.add(BulkOperation.of(o -> o.index(i -> i.document(esSearchWord).id(esSearchWord.getContent()))));
        }
