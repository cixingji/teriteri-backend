package com.cixingji.backend.im.handler.exception;

import com.aliyun.oss.ServiceException;
import com.baomidou.mybatisplus.core.toolkit.ObjectUtils;
import com.cixingji.backend.enums.HttpStatusEnum;
import com.cixingji.backend.pojo.ResponseResult;
...
public class GlobalException {
    ...
    public ResponseResult handleServiceException(ServiceException e) {
        ...
        Integer code = getInteger(e.getErrorCode());

        return ObjectUtils.isNotNull(code) ? ResponseResult.fail(code, e.getMessage()) : ResponseResult.fail(e.getMessage());
    }
