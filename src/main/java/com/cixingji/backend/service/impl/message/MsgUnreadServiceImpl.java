package com.cixingji.backend.service.impl.message;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.conditions.update.UpdateWrapper;
import com.cixingji.backend.im.IMServer;
import com.cixingji.backend.mapper.ChatMapper;
import com.cixingji.backend.mapper.MsgUnreadMapper;
import com.cixingji.backend.pojo.entity.Chat;
...
public class MsgUnreadServiceImpl implements MsgUnreadService {
    ...
    public void clearUnread(Integer uid, String column) {
        ...
        msgUnreadMapper.update(null, updateWrapper);
        //TODO 缓存删除(重点)
        //在更新数据库后，立即删除（del）对应的缓存 --清除过期的缓存
        redisUtil.delValue("msg_unread:" + uid);
        ...
        if (msgUnread == null) {
            ...
            if (msgUnread != null) {
                ...
                CompletableFuture.runAsync(() -> {
                    redisUtil.setExObjectValue("msg_unread:" + uid, finalMsgUnread);    // 异步更新到redis 代码在另一个线程中执行
                }, taskExecutor);
            } else {
                //还是空的就说明没有未读消息
